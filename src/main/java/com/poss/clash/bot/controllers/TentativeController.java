...
public class TentativeController implements TentativesApi {
    ...
    protected Tuple2<Tentatives, Set<String>> buildTupleOfTentativesAndSetOfDiscordIds(List<Tentative> list) {
        ...
        return Tuples.of(Tentatives.builder().queues(list).build(), listOfTentativePlayers
    ...
    protected Mono<Tuple2<Tentatives, Map<String, TentativePlayer>>> populateTupleWithTentativePlayerDetails(Tuple2<Tentatives, Set<String>> tuple) {
    ...
    protected Flux<Tentative> swapFluxBasedOnArchivedFlag(Boolean archived, String discordId, String serverId, String tournamentName, String tournamentDay) {
