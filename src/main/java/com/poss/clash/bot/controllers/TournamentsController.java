...
import com.poss.clash.bot.services.RiotService;
...
public class TournamentsController implements TournamentsApi {
  ...
  @Override
  public Mono<ResponseEntity<DetailedTournament>> createTournament(
      String xCausedBy, Mono<DetailedTournament> detailedTournament, ServerWebExchange exchange
  ) {
  ...
  @Override
  public Mono<ResponseEntity<Tournaments>> getTournaments(
      String xCausedBy, String tournament, String day, Boolean upcomingOnly, ServerWebExchange exchange
  ) {
    ...
    return tournamentFlux
        .map(tournamentMapper::clashTournamentToDetailedTournament)
        .collectList()
        .map(listOfTournaments -> Tournaments
            .builder()
  ...
  @Override
  public Mono<ResponseEntity<Tournaments>> retrieveRiotClashTournaments(ServerWebExchange exchange) {
    return riotService
        .retrieveAndPersistTournaments()
        .map(tournamentMapper::clashTournamentToDetailedTournament)
        .collectList()
