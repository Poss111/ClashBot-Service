...
public class TeamSource {
  ...
  private Mono<Event> sendEvent(Event event) {
    return Mono
        .just(this.teamEvent.offer(event))
        .map(result -> {
  ...
  public Mono<Event> sendTeamUpdateEvent(Team teamPayload) {
    return Mono.deferContextual(ctx -> sendEvent(
        ...
        .log()
        .checkpoint(MessageFormat.format("Sent Team update Event for Team {0} caused by {1}", teamPayload.getId(),
                                         ctx.get(CAUSED_BY_KEY))));
  }
  ...
  public Mono<Event> sendTeamCreateEvent(Team teamPayload) {
    return Mono.deferContextual(ctx -> sendEvent(
        ...
        .log()
        .checkpoint(MessageFormat.format("Sent Team create Event for Team {0} caused by {1}", teamPayload.getId(),
                                         ctx.get(CAUSED_BY_KEY))));
  }
  ...
  public Mono<Event> sendTeamJoinedEvent(Team teamPayload) {
    return Mono.deferContextual(ctx -> sendEvent(
        ...
        .log()
        .checkpoint(MessageFormat.format("Sent Team joined Event for Team {0} caused by {1}", teamPayload.getId(),
                                         ctx.get(CAUSED_BY_KEY))));
  }
  ...
  public Mono<Event> sendTeamRemovedEvent(Team teamPayload) {
    return Mono.deferContextual(ctx -> sendEvent(
        ...
        .log()
        .checkpoint(MessageFormat.format("Sent Team removed Event for Team {0} caused by {1}", teamPayload.getId(),
                                         ctx.get(CAUSED_BY_KEY))));
  }
  ...
  public Mono<Event> sendTentativeQueueUpdateEvent(Tentative tentativePayload) {
    return Mono.deferContextual(ctx -> sendEvent(buildTentativeEvent(tentativePayload, null, EventType.UPDATED, null))
        .log()
        .checkpoint(MessageFormat.format("Sent Tentative Update Event for Tentative {0} caused by {1}",
                                         tentativePayload.getId(), null)));
  }
  ...
  public Mono<Event> sendTentativeQueueCreateEvent(Tentative tentativePayload) {
    return Mono.deferContextual(ctx -> sendEvent(
        ...
        .log()
        .checkpoint(MessageFormat.format("Sent Tentative create Event for Tentative {0} caused by {1}",
                                         tentativePayload.getId(), ctx.get(CAUSED_BY_KEY))));
  }
  ...
  public Mono<Event> sendTentativeQueueJoinedEvent(Tentative tentativePayload) {
    return Mono.deferContextual(ctx -> sendEvent(
        ...
        .log()
        .checkpoint(MessageFormat.format("Sent Tentative joined Event for Tentative {0} caused by {1}",
                                         tentativePayload.getId(), ctx.get(CAUSED_BY_KEY))));
  }
  ...
  public Mono<Event> sendTentativeQueueRemovedEvent(Tentative tentativePayload) {
    return Mono.deferContextual(ctx -> sendEvent(
        ...
        .log()
        .checkpoint(MessageFormat.format("Sent Tentative remove Event for Tentative {0} caused by {1}",
                                         tentativePayload.getId(), ctx.get(CAUSED_BY_KEY))));
  }
