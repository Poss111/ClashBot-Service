...
public class TeamControllerTest {
  ...
  class Create {
    ...
    void test_createTeam_shouldCreateATeam() {
      ...
      TeamRequired requestedTeamToCreate = TeamRequired
          .builder()
          .serverId(serverId)
          .name(name)
      ...
      Map<Role, BasePlayerRecord> roleToBasePlayer = Map.of(
          Role.TOP, BasePlayerRecord
              .builder()
              .discordId(playerDetails
                             .getTop()
                             .getDiscordId())
              .build(),
          Role.JG, BasePlayerRecord
              .builder()
              .discordId(playerDetails
                             .getJg()
                             .getDiscordId())
              .build(),
          Role.MID, BasePlayerRecord
              .builder()
              .discordId(playerDetails
                             .getMid()
                             .getDiscordId())
              .build(),
          Role.BOT, BasePlayerRecord
              .builder()
              .discordId(playerDetails
                             .getBot()
                             .getDiscordId())
              .build(),
          Role.SUPP, BasePlayerRecord
              .builder()
              .discordId(playerDetails
                             .getSupp()
                             .getDiscordId())
    ...
    void test_createTeam_shouldValidateThatThereIsAtLeastOnePosition() {
      ...
      StepVerifier
          .create(
              teamController.createTeam(easyRandom.nextObject(String.class), Mono.just(requestedTeamToCreate), null))
  ...
  class AssignUser {
    ...
    void test1() {
      ...
      Mono<PositionDetails> positionDetailsMono = Mono.just(PositionDetails
                                                                .builder()
                                                                .role(Role.TOP)
                                                                .build());
  ...
  class RetrieveTeamById {
    ...
    void test() {
      ClashTeam clashTeamToBeReturned = easyRandom.nextObject(ClashTeam.class);
      when(teamService.findTeamById(clashTeamToBeReturned
                                        .getTeamId()
                                        .getId()))
          .thenReturn(Mono.just(clashTeamToBeReturned));
      ...
      String xCausedBy = easyRandom.nextObject(String.class);
      StepVerifier
          .create(teamController.retrieveTeamBasedOnId(xCausedBy, clashTeamToBeReturned
              .getTeamId()
              .getId(), null))
          .expectAccessibleContext()
          .contains(CAUSED_BY_KEY, xCausedBy)
  ...
  class RetrieveTeams {
    ...
    void test() {
      ...
      Teams expectedResponse = Teams
          .builder()
          .teams(filteredClashTeams
                     .stream()
    ...
    void test2() {
      ...
      List<ArchivedClashTeam> filteredClashTeams = List.of(
          ...
          clashTeam2,
          clashTeam3);
      when(archivedService.retrieveArchivedTeamBasedOnCriteria(
          discordId,
          serverId,
          tournamentId.getTournamentName(),
          tournamentId.getTournamentDay())
  ...
  class UpdateTeam {
    ...
    void test() {
      ...
      TeamUpdate teamNameUpdate = TeamUpdate
          .builder()
          .teamName(newName)
          .build();
