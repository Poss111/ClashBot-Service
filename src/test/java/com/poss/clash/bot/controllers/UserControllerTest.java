...
public class UserControllerTest {
    ...
    class AddToPreferredChamps {
        ...
        void test() {
            ...
            StepVerifier
                    .create(
                            userController.addToPreferredChampionsForUser(xCausedBy, discordId,
                                    Mono.just(championsListToAdd), null))
                    .expectAccessibleContext()
                    .contains(CAUSED_BY_KEY, xCausedBy)
                    .then()
                    .expectNextMatches(response -> championsListToAdd
                            .getChampions()
                            .size() == response
                                    .getBody()
                                    .getChampions()
    ...
    class CreateListOfPreferredChamps {
        ...
        void test() {
            ...
            StepVerifier
                    .create(
                            userController.createListOfPreferredChampionsForUser(xCausedBy, discordId,
                                    Mono.just(championsListToAdd),
                                    null))
                    .expectAccessibleContext()
                    .contains(CAUSED_BY_KEY, xCausedBy)
                    .then()
    ...
    class SubscribeUser {
        ...
        void test() {
            ...
            when(userService.toggleUserSubscription(user.getDiscordId(), UserSubscription.DISCORD_MONDAY_NOTIFICATION,
                    true))
            ...
            StepVerifier
                    .create(
                            userController.subscribeUser(xCausedBy, user.getDiscordId(),
    ...
    class RetrieveUserSubscription {
        ...
        void test() {
            ...
            when(userService.retrieveUser(
                    user.getDiscordId())).thenReturn(Mono.just(user));
        ...
        void test2() {
            ...
            when(userService.retrieveUser(
                    user.getDiscordId())).thenReturn(Mono.empty());
