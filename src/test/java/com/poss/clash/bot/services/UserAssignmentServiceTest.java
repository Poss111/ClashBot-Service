  ...
  class TeamInteractions {
    ...
    class Assign {
      ...
      void test_assignUserToTeam_userDoesNotExistOnOtherTeamOrTentativeQueues() {
        ...
        ClashTeam retrievedTeam = ClashTeam
            .builder()
            .teamId(teamId)
            .teamName(teamName)
            .serverId(serverId)
        ...
        ClashTeam returnedClashTeam = ClashTeam
            .builder()
            .teamId(teamId)
            .teamName(teamName)
            .serverId(serverId)
            .positions(Map.of(Role.TOP, BasePlayerRecord
                .builder()
                .discordId(discordId)
                .build()))
            .build();
        ...
        when(teamSource.sendTeamJoinedEvent(teamSourceArgumentCaptor.capture()))
        ...
        StepVerifier
            .create(userAssignmentService
                        .assignUserToTeam(discordId, Role.TOP, clashTeamId)
        ...
        verify(userAssociationService, times(1))
            .retrieveUsersTeamOrTentativeQueueForTournament(discordId, tournamentId.getTournamentName(),
                                                            tournamentId.getTournamentDay());
        verify(userAssociationService, times(1))
            .save(expectedUserAssociation);

        assertAll(() -> {
          assertEquals(1, teamSourceArgumentCaptor
              .getAllValues()
              .size(), "More events executed than expected");
          verifyTeamEvent(serverId, returnedClashTeam, teamSourceArgumentCaptor
              .getAllValues()
              .get(0));
        });
      }
      ...
      void test_assignUserToTeam_userExistsOnAnotherTeam() {
        ...
        UserAssociation otherTeamUserAssociation = UserAssociation
            .builder()
        ...
        ClashTeam teamAfterRemoval = ClashTeam
            .builder()
            .serverId(serverId)
            .teamId(TeamId
                        .builder()
        ...
        verify(teamSource, times(1))
            .sendTeamJoinedEvent(any(Team.class));

        assertAll(() -> {
          assertEquals(2, teamSourceArgumentCaptor
              .getAllValues()
              .size(), "More events executed than expected");
          verifyTeamEvent(serverId, teamAfterRemoval, teamSourceArgumentCaptor
              .getAllValues()
              .get(0));
          verifyTeamEvent(serverId, returnedClashTeam, teamSourceArgumentCaptor
              .getAllValues()
      ...
      void test_assignUserToTeam_userExistsOnATentativeQueue() {
        ...
        UserAssociation otherTentativeQueueUserAssociation = UserAssociation
            .builder()
        ...
        assertAll(() -> {
          assertEquals(1, tentativeArgumentCaptor
              .getAllValues()
              .size(), "More Tentative events executed than expected");
          assertEquals(1, teamSourceArgumentCaptor
              .getAllValues()
              .size(), "More Team events executed than expected");
          verifyTentativeEvent(serverId, updatedTentativeQueue, tentativeArgumentCaptor
              .getAllValues()
              .get(0));
          verifyTeamEvent(serverId, returnedClashTeam, teamSourceArgumentCaptor
              .getAllValues()
      ...
      void test_validateTeamAvailability_error_roleIsAlreadyTakenForATeam() {
        ...
        ClashBotDbException clashBotDbException = assertThrows(ClashBotDbException.class,
                                                               () -> userAssignmentService.validateTeamAvailability(
                                                                   Role.TOP, returnedClashTeam));
        assertEquals(
            MessageFormat.format("Role {0} already taken on Team {1}", Role.TOP, returnedClashTeam.getTeamId()),
            clashBotDbException.getMessage());
      }
    ...
    class Create {
      ...
      void test_createTeamAndAssignUser_userDoesNotExistOnAnything() {
        ...
        positions.put(Role.TOP, BasePlayerRecord
            .builder()
            .discordId(discordId)
            .build());
        HashMap<Role, String> roleToIdMap = new HashMap<>();
        roleToIdMap.put(Role.TOP, discordId);
        ClashTeam expectedTeamToCreate = ClashTeam
            .builder()
            .teamId(TeamId
                        .builder()
                        .tournamentId(tournamentId)
        ...
        ClashTeam createdTeam = ClashTeam
            .builder()
            .teamId(TeamId
                        .builder()
                        .tournamentId(tournamentId)
        ...
        UserAssociation createTeamUA = UserAssociation
            .builder()
            .userAssociationKey(UserAssociationKey
                                    .builder()
                                    .tournamentId(tournamentId)
        ...
        assertAll(() -> {
          assertEquals(1, teamSourceArgumentCaptor
              .getAllValues()
              .size(), "More events executed than expected");
          verifyTeamEvent(discordServerId, createdTeam, teamSourceArgumentCaptor
              .getAllValues()
              .get(0));
        });
      }
      ...
      void test_createTeamAndAssignUser_userDoesExistsOnAnotherTeam() {
        ...
        when(userAssociationService.retrieveUsersTeamOrTentativeQueueForTournament(discordId,
            ...
            .thenReturn(Mono.just(UserAssociation
                                      ...
                                      .serverId(discordServerId)
                                      .build()));
        ClashTeam teamToBeRemovedFrom = ClashTeam
            .builder()
            .teamId(TeamId
                        .builder()
                        .id(otherTeamId)
        ...
        assertEquals(2, teamSourceArgumentCaptor
            .getAllValues()
            .size(), "More events executed than expected");
        verifyTeamEvent(discordServerId, teamToBeRemovedFrom, teamSourceArgumentCaptor
            .getAllValues()
            .get(0));
        verifyTeamEvent(discordServerId, createdTeam, teamSourceArgumentCaptor
            .getAllValues()
      ...
      void test_createTeamAndAssignUser_allPositions_usersDoNotExistOnAnything() {
        ...
        positions.put(Role.TOP, BasePlayerRecord
            ...
            .discordId(discordId)
            .build());
        positions.put(Role.JG, BasePlayerRecord
            .builder()
            .discordId(discordIdTwo)
            .build());
        positions.put(Role.MID, BasePlayerRecord
            .builder()
            .discordId(discordIdThree)
            .build());
        positions.put(Role.BOT, BasePlayerRecord
            .builder()
            .discordId(discordIdFour)
            .build());
        positions.put(Role.SUPP, BasePlayerRecord
            .builder()
        ...
        List<UserAssociation> expectedUserAssociations = discordIds
            .stream()
            .map(id -> UserAssociation
                .builder()
                .userAssociationKey(UserAssociationKey
                                        .builder()
                                        .tournamentId(tournamentId)
      ...
      void test_createTeamAndAssignUser_allPositions_usersDoExistOnOtherTeams() {
        ...
        assertEquals(6, teamSourceArgumentCaptor
            .getAllValues()
            .size(), "More events executed than expected");

        for (int i = 0; i < 5; i++) {
          var team = teamSourceArgumentCaptor
              .getAllValues()
              .get(i);
          assertNotNull(team);
        ...
        assertNotNull(teamSourceArgumentCaptor
                          .getAllValues()
                          .get(5)
                          .getId());
        assertEquals(discordServerId, teamSourceArgumentCaptor
            .getAllValues()
            .get(5)
            .getServerId());
        assertEquals(teamMapper.clashTeamToTeam(createdTeam), teamSourceArgumentCaptor
            .getAllValues()
            .get(5));
      }
      ...
      void test_createTeamAndAssignUser_userDoesExistsOnAnotherTentativeQueue() {
        ...
        assertEquals(1, teamSourceArgumentCaptor
            .getAllValues()
            .size(), "More Team events executed than expected");
        verifyTentativeEvent(tentativeQueueToBeRemovedFrom
                                 .getTentativeId()
                                 .getServerId(), tentativeQueueToBeRemovedFrom, tentativeArgumentCaptor
                                 .getAllValues()
                                 .get(0));
        verifyTeamEvent(discordServerId, createdTeam, teamSourceArgumentCaptor
            .getAllValues()
    ...
    class Remove {
      ...
      void test_removeUserFromTeam() {
        ...
        ClashTeam teamToBeRemovedFrom = ClashTeam
            ...
            .positions(positions)
            .build();
        ClashTeam teamAfterUpdate = ClashTeam
            .builder()
            .teamId(TeamId
                        .builder()
                        .id(clashTeamId)
        ...
        UserAssociationKey associationKey = UserAssociationKey
            .builder()
            .discordId(discordId)
            .tournamentId(tournamentId)
            .build();
  ...
  class TentativeQueues {
    ...
    class Assign {
      ...
      void test() {
        ...
        TournamentId tournamentId = easyRandom.nextObject(TournamentId.class);
        TentativeQueue tentativeQueueToBeAssignedTo = TentativeQueue
            .builder()
            ...
            .tentativeId(TentativeId
                             ...
                             .build())
            .build();
        TentativeQueue tentativeQueueAfterAssignment = TentativeQueue
            .builder()
        ...
        UserAssociation userAssociationToSave = UserAssociation
            .builder()
            .userAssociationKey(UserAssociationKey
                                    .builder()
                                    .discordId(discordId)
        ...
        when(teamSource.sendTentativeQueueJoinedEvent(tentativeArgumentCaptor.capture()))
            .thenReturn(Mono.just(Event
                                      .builder()
                                      .build()));
        ...
        verify(teamSource, times(1))
            .sendTentativeQueueJoinedEvent(any(Tentative.class));

        assertEquals(1, tentativeArgumentCaptor
            .getAllValues()
            .size());
        verifyTentativeEvent(serverId, tentativeQueueAfterAssignment, tentativeArgumentCaptor
            .getAllValues()
            .get(0));
      }
      ...
      void test2() {
        ...
        TentativeQueue tentativeQueueAfterAssignment = TentativeQueue
            ...
            .tentativeId(TentativeId
                             ...
                             .build())
            .build();
        UserAssociation teamUserAssociation = UserAssociation
            .builder()
            .userAssociationKey(UserAssociationKey
                                    .builder()
                                    .discordId(discordId)
        ...
        ClashTeam returnedTeam = ClashTeam
            .builder()
            .teamId(TeamId
                        .builder()
                        .id(clashTeamId)
    ...
    class Create {
      ...
      void test() {
        ...
        TournamentId tournamentId = easyRandom.nextObject(TournamentId.class);
        TentativeQueue tentativeQueueToCreate = TentativeQueue
            .builder()
            .tentativeId(TentativeId
                             .builder()
                             .serverId(serverId)
            ...
            .discordIds(Set.of(discordId))
            .build();
        TentativeQueue createdTentativeQueue = TentativeQueue
            .builder()
            .tentativeId(TentativeId
                             .builder()
                             .tentativeId(tentativeId)
            ...
            .discordIds(Set.of(discordId))
            .build();
        UserAssociation createdUserAssociation = UserAssociation
            .builder()
            .tentativeId(tentativeId)
            .userAssociationKey(UserAssociationKey
                                    .builder()
        ...
        assertEquals(1, tentativeArgumentCaptor
            .getAllValues()
            .size());
        verifyTentativeEvent(serverId, createdTentativeQueue, tentativeArgumentCaptor
            .getAllValues()
            .get(0));
      }
      ...
      void test2() {
        ...
        TentativeQueue createdTentativeQueue = TentativeQueue
            ...
            .discordIds(Set.of(discordId))
            .build();
        UserAssociation currentAssociation = UserAssociation
            .builder()
            .teamId(clashTeamId)
            .userAssociationKey(UserAssociationKey
                                    .builder()
        ...
        assertAll(() -> {
          assertEquals(1, teamSourceArgumentCaptor
              .getAllValues()
              .size());
          Team updateEventSubmitted = teamSourceArgumentCaptor
              .getAllValues()
              .get(0);
          assertNotNull(updateEventSubmitted.getId());
          ...
          assertEquals(1, tentativeArgumentCaptor
              .getAllValues()
              .size());
          Tentative createEventSubmitted = tentativeArgumentCaptor
              .getAllValues()
              .get(0);
    ...
    class Remove {
      ...
      void test() {
        ...
        discordIds.add("1");
        TentativeQueue tentativeQueueToBeRemovedFrom = TentativeQueue
            .builder()
            ...
            .tentativeId(TentativeId
                             ...
                             .build())
            .build();
        TentativeQueue tentativeQueueAfterRemoval = TentativeQueue
            .builder()
            .discordIds(new HashSet<>())
            .tentativeId(TentativeId
                             .builder()
        ...
        Tentative removeEventSubmitted = tentativeArgumentCaptor
            .getAllValues()
            .get(0);
